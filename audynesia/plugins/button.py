...
@udy.cod_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [AudyNesia]<buttonurl:https://github.com/hitokizzy/AudyNesia:same> [support]<buttonurl:https://t.me/HexxaUserbotGroup>",
    },
)
async def _(event):
...
@udy.cod_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test [google]<buttonurl:https://www.google.com> [AudyNesia]<buttonurl:https://github.com/hitokizzy/AudyNesia:same> [support]<buttonurl:https://t.me/HexxaUserbotGroup>",
    },
)
async def _(event):
