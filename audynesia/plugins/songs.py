...
#                           STRINGS                           #
# =========================================================== #
SONG_SEARCH_STRING = "<code>finding your song....</code>"
SONG_NOT_FOUND = "<code>Sorry !I am unable to find any song like that</code>"
SONG_SENDING_STRING = "<code>Song founded...</code>"
...
async def _(event):
    ...
    codevent = await edit_or_reply(event, "`finding your song....`")
    ...
    await codevent.edit("`Song Founded...`")
