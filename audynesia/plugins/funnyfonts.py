...
@udy.cod_cmd(
    ...
    info={
        ...
        "examples": "{tr}downside AudyNesia",
    },
)
...
@udy.cod_cmd(
    ...
    info={
        ...
        "examples": "{tr}subscript AudyNesia",
    },
)
async def stylish_generator(event):
...
@udy.cod_cmd(
    ...
    info={
        ...
        "examples": "{tr}superscript AudyNesia",
    },
)
async def stylish_generator(event):
