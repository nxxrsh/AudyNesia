...
from . import edit_delete, edit_or_reply, mention, udy
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m audynesia`",
        "**State changed from starting to up**",
        "__INFO:audynesia:Logged in as 557667062__",
        "__INFO:audynesia:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
async def _(event):
    ...
    event = await edit_or_reply(event, "AudyNesia network boosting...")
    animation_chars = [
        "`Connecting To AudyNesia NETWORK ....`",
        "`█ ▇ ▆ ▅ ▄ ▂ ▁`",
        "`▒ ▇ ▆ ▅ ▄ ▂ ▁`",
        "`▒ ▒ ▆ ▅ ▄ ▂ ▁`",
        "`▒ ▒ ▒ ▅ ▄ ▂ ▁`",
