...
@udy.cod_cmd(
    ...
    info={
        ...
        "examples": "{tr}fmusical AudyNesia",
    },
)
...
@udy.cod_cmd(
    ...
    info={
        ...
        "examples": "{tr}smallcaps AudyNesia",
    },
)
async def stylish_generator(event):
    "Changes font style of the given text"
