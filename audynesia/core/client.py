...
class udyclient(TelegramClient):
    def cod_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            ...
            if pattern is not None:
                ...
                if edited:
                    udy.add_event_handler(func, events.MessageEdited(**kwargs))
                udy.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                udy.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                udy.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
udyclient.fast_download_file = download_file
udyclient.fast_upload_file = upload_file
udyclient.reload = restart_script
udyclient.get_msg_link = get_message_link
udyclient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    udyclient.send_message = send_message
    udyclient.send_file = send_file
    udyclient.edit_message = edit_message
